...
\\  Below we show an implementation which verify the following two lemmas.
...
\\ LEMMA II: 
\\        u*S \subset S,
\\ where S is complex of "m" pointed polyhdral cones, for m=8, 10 or 12.
\\ and "u" is one fundamental unit of "k=bnfinit(p)", given by PARI/GP.

\\ These lemmas are based in our MANUSCRIPT (MS):
...
D=concat(D);
return(D);
\\ D represents the difference of polyhedral complexes "u*S-S", if this is empty, u*S \subset S.
}
...
/*******************************************************************************************************/
\\Subroutines used in STEP 1 (of LEMMA I)
...
/*******************************************************************************************************/
\\Subroutines used in STEP 2 (OF LEMMA I)
...
/*******************************************************************************************************/
\\Subroutines used in STEP 3 (OF LEMMA I)
