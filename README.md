...
* $v =$ vector of four entries [#(four-cones),#(three-cones),#(two-cones),#(one-cones)] which describes information of the number semi-closed cones obtained in a Shintani domain obtained by execution of command $torfDK41(p,flag)$.
