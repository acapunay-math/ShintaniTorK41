...
by A. CAPUÑAY, M. ESPINOZA AND E. FRIEDMAN, which extend our implementation given in [Attractor-repulsor](https://github.com/acapunay-math/ShintaniK41)


## File description

$(I).$ After uploading the file `ShintaniTorK41.gp` in Pari/GP, using an irreducible polynomial $p$ which defines a complex quartic number field, then you can use the command
